...
"""
equity_history_url_full = URLFetchSession(url='https://www.nseindia.com/products/dynaContent/common/productsSymbolMapping.jsp')
...
equity_history_url = URLFetchSession('https://www.nseindia.com/products/dynaContent/common/productsSymbolMapping.jsp?symbol=%s&segmentLink=3&symbolCount=%s&series=EQ&dateRange=+&fromDate=%s&toDate=%s&dataType=PRICEVOLUMEDELIVERABLE')
...
"""
index_pe_history_url = partial(URLFetchSession(url='http://www.nseindia.com/products/dynaContent/equities/indices/historical_pepb.jsp?'),
                               yield1="undefined",
                               yield2="undefined",
                               yield3="undefined",
                               yield4="all")
...
symbolCount=
"""
derivative_history_url = partial(URLFetchSession(url='http://www.nseindia.com/products/dynaContent/common/productsSymbolMapping.jsp?'),
                                 segmentLink=9,
                                 symbolCount='')
"""
